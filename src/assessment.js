...
//NEED TO USE implicitly call, bind

var Chimichanga = function(eat){
  this.percentLeft = 100;
  this.eat = function(){
...
function sentenceMachine(partOne){
  var sentenceSmasher = function sentenceSmasher(partTwo){
...
function subway(personName){
  var arr = [];
  var addIngredient = function(ingredients){
...
function compareValues(param1, param2){
  ...
  else if(param1 == param2) return "Different types";
